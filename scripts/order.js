...
ymaps.ready(() => {
    // Создаем карту с центром в пос. Крестцы и приближением 6.5 (сразу и Санкт-Петербург и Москва видны на карте).
    map = new ymaps.Map('map', {
        center: [58.251652, 32.511619],
        zoom: 6.5,
...
submitButton.addEventListener('click', async () => {
    ...
    console.log('Заказ: ' + payload.id, payload, calculation);
